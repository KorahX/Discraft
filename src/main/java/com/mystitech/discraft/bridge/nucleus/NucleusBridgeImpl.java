package com.mystitech.discraft.bridge.nucleus;
...
public class NucleusBridgeImpl extends NucleusBridge {
    ...
    public void onAfk(Player player, boolean goingAfk) {
        if (!player.hasPermission("discraft.chat")) return;
    ...
    public void onHelpOp(Player player, Text message) {
        ...
        DiscordMessageBuilder.forChannel(channel)
                ...
                .format(format)
                .allowEveryone(player.hasPermission("discraft.everyone"))
                .allowHere(player.hasPermission("discraft.here"))
                .allowMentions(player.hasPermission("discraft.mention"))
                .useWebhook(false)
                .send();
    }
